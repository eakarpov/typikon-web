...
export const VERSIFICATIONS: Versification[] = [
    ...
    // Еврейский счёт. Первое издание у нас, переведённое не с греческого и не с
    // латыни, а с оригинала, — чувашское. Расходится он со славянским прежде
    // всего в Псалтири: Семьдесят слили 9-й псалом с 10-м и 114-й со 115-м, а
    // 116-й и 147-й, наоборот, разделили, отчего почти вся книга идёт под
    // номером на единицу меньше еврейского.
    { id: "mt", label: "еврейская (масоретский счёт)", reference: false },
];
