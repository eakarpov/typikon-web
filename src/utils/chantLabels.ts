...
export const UNIT_LABELS: Record<string, string> = {
    ...
    "ipakoi": "ипакои",
    "verse": "стих",
    // Молитва — тоже род строки корпуса, а не только отдельный раздел: она
    // стоит и внутри последования. Без подписи выпадала латиницей в отборе
    // указателя зачинов, где перечислены все роды разом.
    "molitva": "молитва",
};
