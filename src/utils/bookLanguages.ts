...
export const BOOK_LANGUAGES: BookLanguage[] = [
    ...
    // Румынский и английский пришли с богослужебными книгами, а не с
    // библиотекой: румынская Минея и Октоих (издание 1929) и английский слой
    // AGES. У английского переводов несколько на одно место — Дедес, Лэш,
    // OCA, — и различает их не язык, а издание.
    { code: "ro", label: "румынский", short: "рум.", needsChurchFont: false },
    { code: "en", label: "английский", short: "англ.", needsChurchFont: false },
    // Латынь Климентины — с лигатурами æ и œ («cælum», «præceptum»). Системные
    // шрифты их держат, церковный не нужен.
    { code: "la", label: "латинский (Вульгата)", short: "лат.", needsChurchFont: false },
    // Эстонский и арабский пришли тем же путём, что румынский с английским, —
    // с богослужебными книгами: воскресный Октоих ЭАПЦ и путеводитель
    // Антиохийской архиепископии. В библиотеке их нет и, возможно, не будет, но
    // в корпусе на них 1 284 и 328 строк, и указатель зачинов их показывает —
    // значит, называть их «et» и «ar» уже нельзя.
    { code: "et", label: "эстонский", short: "эст.", needsChurchFont: false },
    { code: "ar", label: "арабский", short: "араб.", needsChurchFont: false },
    // Чувашский в двух начертаниях. Обычное — нынешняя кириллица с ӑ, ӗ, ҫ, ӳ:
    // системные шрифты её держат. Церковное — азбука проекта «Азбуки»: там ъ и ь
    // снова гласные, ꙋ и ѵ на своих местах, а над буквами стоят оксия с варией.
    // Обычным шрифтом оно осыплется так же, как славянское, отсюда пометка.
    { code: "cv", label: "чувашский", short: "чув.", needsChurchFont: false },
    { code: "cv_cu", label: "чувашский (церковная азбука)", short: "чув. цр.", needsChurchFont: true },
];
