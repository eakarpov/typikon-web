...
const STATUS: Record<ErrorCode, number> = {
    ...
    // Движок устава — отдельная служба на 127.0.0.1 (см. @/lib/ordo), и она
    // может быть не поднята, перегружена или отвечать ошибкой сборки. Сайт при
    // этом жив, отсюда тот же 503, но свой код: причина в другом компоненте,
    // и «переложить запрос позже» — рабочий совет, а не «пишите в поддержку».
    ordo_unavailable: 503,
