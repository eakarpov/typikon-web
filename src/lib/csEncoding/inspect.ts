...
export const FLAG_NOTES: Record<ClusterFlag, string> = {
    ...
    "private-use": "знак из области частного использования. Церковнославянские шрифты "
        + "семейства Ponomar размещают там сложенные сочетания (звательце с ударением, "
        + "выносную с покрытием) и варианты начертаний; набор с ними правилен и в своём "
        + "шрифте читается, но за его пределами не отображается, а нашей нормализацией "
        + "написаний не сводится.",
};
