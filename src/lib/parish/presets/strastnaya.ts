...
// СТРАСТНАЯ И ПАСХА. Единственная неделя года, расписание которой ответственный
...
export const strastnaya: ParishRule[] = [
    ...
    },
    {
        ...
        note: "часы Великого Пятка — царские: на каждом свои псалмы, паримия, "
            + "Апостол и Евангелие. Служатся все четыре подряд, и по девятом — "
            + "изобразительны: Литургии в этот день не полагается",
        then: { set: { part: "utro", time: "08:00",
                       title: "Царские часы. Изобразительны" } },
    },
    {
        key: "pyatok-vynos",
