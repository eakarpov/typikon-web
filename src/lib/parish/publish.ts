...
// «ЭТОТ МЕСЯЦ ГОТОВ».
//
// Пока ответственный не сказал этого, расписание остаётся ПРОЕКТОМ: оно выведено
...
// опубликованное так вести себя не вправе: ответственный повесил на стенд
...
// разошёлся ли он с уставом — видит ответственный, и решает он.
 ...
 * чисел, а не «да/нет»: ответственному надо знать, где смотреть.
 */
