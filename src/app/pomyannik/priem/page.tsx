            ...
            <div className="max-w-2xl">
                ...
                {person ? (
                    <p className="font-serif text-slate-800 mt-2">
                        ...
                        Ссылку-приглашение можно раздать прихожанам или повесить знаком на стенде.
                    </p>
                ) : (
                    <>
                        <p className="font-serif text-slate-800 mt-2">
                        ...
                        <p className="font-serif text-slate-600 text-sm mt-2">
                            <strong>Оплат на сайте нет и не будет.</strong> Записка приходит к вам
                            напрямую; ни мы, ни приход в этом не участвуем и ничего с этого не
                            имеем. Оттого и право здесь личное, ваше, а не приходское.
                        </p>
                        <p className="font-serif text-slate-600 text-sm mt-2">
                            <strong>Сан мы не удостоверяем</strong> — за него отвечает епархия. Мы
