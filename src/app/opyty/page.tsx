...
export const metadata: Metadata = {
    ...
    description:
        ...
        "словарь церковнославянских слов, древо князей и царей.",
};
...
const OPYTY: Opyt[] = [
    ...
    {
        href: "/dictionary",
        title: "Словарь церковнославянских слов",
        what: "Склонение и спряжение: как слово изменяется по падежам и лицам.",
        caveat: "Начат как проба и дальше отдельным направлением не развивается — " +
            "работает как есть.",
    },
    {
        href: "/nobles",
