...
const OPYTY: Opyt[] = [
    ...
    },
    {
        href: "/azbuki",
        title: "Азбуки",
        what: "Опыты письма: как записать язык алфавитом, которого у него нет. Пока одна — " +
            "китайская латиница, выведенная из среднекитайской фонологии «Гуанъюня» " +
            "(1008 г.), а не из нынешнего произношения.",
        caveat: "Это построения, а не письменности в употреблении: так не пишут и не писали. " +
            "Читать вслух нельзя — записано звучание XI века, а современное чтение " +
            "выводится правилами, верными в 82–86% случаев.",
    },
    {
        href: "/nobles",
