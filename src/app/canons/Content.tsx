                ...
                {data.items.map(canon => (
                    <div key={canon.id} className="flex flex-col">
                        ...
                        <div className="text-xs text-slate-500 font-serif">
                            ...
                            {/* В списке — имя лица, если оно есть: искать глазами
                                «Иосиф Песнописец» проще, чем «Творе́ние
                                Ио́сифово.] Гла́с 3.». Напечатанное надписание
                                целиком стоит на странице самого канона. */}
                            {canon.author ? ` · ${canon.author}` : canon.creator ? ` · ${canon.creator}` : ""}
