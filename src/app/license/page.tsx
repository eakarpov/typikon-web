...
const License = () => (
    <div className={`${myFont.variable} flex flex-col gap-4 pt-4 pb-8 font-serif`}>
        ...
        <section className="flex flex-col gap-2">
            ...
            <p>
                Греческий Новый Завет того же издания есть в общественном достоянии —
                выверенный М. Робинсоном текст Антониадиса. Но он{" "}
                <b>без ударений и придыханий</b>: годен для разбора и морфологии, не для
                богослужебного чтения. Поэтому на сайте стоит не он, и менять ради лицензии
                не станем — снять ударения с греческого текста дороже, чем не выложить его.
            </p>
        </section>
