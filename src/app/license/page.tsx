    ...
    <div className={`${myFont.variable} flex flex-col gap-4 pt-4 pb-8 font-serif`}>
        ...
        <section className="flex flex-col gap-2">
            ...
            <p>
                ...
                чужая работа на своих условиях, и наша лицензия на неё не распространяется.
            </p>
            <p>
                Греческий Ветхий Завет — исключение в хорошую сторону: оцифровщик выпустил
                его под GPL-3.0, то есть распространять <b>разрешил</b>, только на своих
                условиях. В{" "}
                <Link href="/data" className="text-amber-800 underline underline-offset-4">
                    выгрузке
                </Link>{" "}
                он и лежит отдельным файлом под GPL-3.0, с полным текстом лицензии рядом.
                Церковнославянская и латинская оцифровки условий не заявляют вовсе — их мы
                не распространяем.
            </p>
            <p>
                Греческий Новый Завет — Патриаршее издание 1904/1912 — берётся у eBible.org,
                который отдаёт его как <b>общественное достояние</b>, с ударениями и
                полностью. Прежде текст был взят у библиотеки Элладской Церкви, где условий
                не заявлено.
            </p>
            <p>
                Замена вышла не уступкой ради лицензии, а исправлением: оба текста сверены с
                выверенным по печатному изданию текстом М. Робинсона, и открытый оказался
                ближе к печатному — 96,1% против 89,1%. Около 556 стихов печатному изданию
                отвечал он, а не мы.
            </p>
        </section>
