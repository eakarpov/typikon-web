...
const License = () => (
    <div className={`${myFont.variable} flex flex-col gap-4 pt-4 pb-8 font-serif`}>
        ...
        <section className="flex flex-col gap-2">
            ...
            <p>
                Изданий девять, и происхождение у них разное. Наша работа во всех девяти одна:
            ...
            <p>
                Чувашских изданий два, и это один текст в двух начертаниях. Перевод —
                Института перевода Библии, и он <b>под правами правообладателя</b>: мы его
                не распространяем, в{" "}
                <Link href="/data" className="text-amber-800 underline underline-offset-4">
                    выгрузку
                </Link>{" "}
                он не идёт. Наше в нём — разбор и церковная запись: чувашская церковная
                азбука и преобразователь к ней сделаны в проекте «Азбуки», и второе издание
                получено прогоном первого через него.
            </p>
            <p>
                Разбор чувашского текста отдельно стоит назвать работой, а не переносом.
                Страницы источника местами теряли номера стихов — чаще всего одиннадцатый, —
                и ставили на их место букву: кириллические <b>З</b>, <b>О</b>, <b>Ч</b>
                неотличимы от цифр 3, 0, 4, и перекодировка их путала в обе стороны. Где
                восстановить номер удавалось по следу, он восстановлен; где нет — стих
                помечен отсутствующим. Все решения выписаны построчно и открыты для спора.
            </p>
        </section>
