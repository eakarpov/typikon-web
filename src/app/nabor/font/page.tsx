    ...
    <div className={`${myFont.variable} ${csFontVariables} pt-2 flex flex-col gap-5`}>
        <div className="max-w-2xl">
            ...
            <p className="font-serif text-slate-600 text-sm mt-2">
                <strong>Это не то же, что проверка шрифта у читателя.</strong> Там мы измеряем,
                что нарисовал браузер, приметами, каждая из которых по-своему неточна. Здесь
                читается сам файл, и ответ точен: знак либо объявлен в таблице соответствий,
                либо нет. Файл при этом никуда не передаётся.
            </p>
        </div>
