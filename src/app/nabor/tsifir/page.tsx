...
// Две мелочи на одной странице, и это не экономия.
//
// Обе про одно: прочесть церковнославянское написание тем, чем умеет работать
// нынешняя техника. Цифирь переводит число, гражданка — буквы; отдельной
// страницы ни та, ни другая не несёт, а вместе они и есть «прочесть».
// Обе считались у нас годами внутри — цифирь разбирала румынский набор 1688
// года, гражданка сводила написания при поиске, — и наружу не выходили.
    ...
    <div className={`${myFont.variable} ${csFont.variable} pt-2 flex flex-col gap-6`}>
        ...
        <section className="max-w-2xl">
            ...
            <p className="font-serif text-slate-600 text-sm mt-1 mb-3">
                ...
                обязательна</strong>: без титла «ми» — предлог, а не 48, и считать его
                числом значило бы резать текст по живому.
            </p>
            <NumeralForm />
        </section>
