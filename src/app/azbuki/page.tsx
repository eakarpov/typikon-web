...
export const metadata: Metadata = {
    ...
    description:
        ...
        "Китайская латиница из среднекитайской фонологии «Гуанъюня», кириллица для " +
        "польского, где ять держит корень воедино, и церковный облик чувашского письма.",
    openGraph: {
        title: "Азбуки",
...
const AZBUKI: Azbuka[] = [
    ...
    },
    {
        ...
        what: "Не транслит латиницы, а правописание: то, что польская запись потеряла, " +
            "здесь пишется буквой. Ять склеивает корень, который латиница рвёт " +
            "(mieć/miał → мѣць/мѣл, świat/świecie → свѣт/свѣцє), ѡ держит старопольскую " +
            "долготу (Bóg/Boga → Бѡг/Бога), а диграфы исчезают: Szczebrzeszynie — " +
            "это Щебр̌ешынѣ.",
        caveat: "По-польски так не пишут: это построение. Но читать его вслух можно — " +
            "оно отвечает нынешнему языку, и перевод в обе стороны механичен везде, " +
            "кроме ятя: где он стоит, знает только словник из 59 697 словоформ, " +
            "а в незнакомом слове азбука его не поставит.",
    },
    {
        href: "/azbuki/chuvash",
        title: "Чувашская церковная азбука",
        what: "Не новая письменность, а церковный облик для существующей: ӑ и ӗ возвращаются " +
            "к ерам, которыми и были по звучанию, ӳ — к ижице, ҫ — к щ, а мягкость метится " +
            "знаком на самой согласной. Двадцать восемь букв против нынешних тридцати семи: " +
            "звонких в чувашском слове не нужно ни одной, звонкость там позиционная.",
        caveat: "Почти каждое решение подтверждено печатью — казанским Евангелием 1873 года " +
            "с предисловием Яковлева, первой книгой его азбуки. Неподтверждённое вынесено " +
            "переключателями: оглушать ли заимствования, чем держать конечную звонкую, " +
            "ставить ли титла.",
    },
];
