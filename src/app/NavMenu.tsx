            ...
            <div className="flex flex-row gap-4 grow">
                ...
                <NavGroup
                    ...
                    items={[
                        ...
                        // Разбор набранного — для того, кто набирает: рядом с
                        // ударениями, потому что вместе они и составляют
                        // рабочее место наборщика.
                        { href: "/razbor", label: "Разбор текста" },
                        // Инструменты набора — одной ссылкой на указатель, а не
                        // группой: их четыре, и каждый новый распирал бы шапку.
                        // Собирает их страница раздела, а не меню.
                        { href: "/nabor", label: "Церковнославянский набор" },
                        ...
                        // «Что рядом» и поездка стоят на тех же храмах и местах:
                        // по ним узнают, кто почитается вокруг и что читать в пути.
                        { href: "/ryadom", label: "Что рядом" },
                        { href: "/palomnichestvo", label: "Поездка" },
