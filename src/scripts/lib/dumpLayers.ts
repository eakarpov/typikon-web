...
export const LAYERS: DumpLayer[] = [
    ...
    },
    {
        ...
        rationale:
            ...
            + "китайский Новый Завет 1910 набирали мы — они под лицензией слоя. Румынская "
            + "синодальная 1914 взята из Викитеки и идёт под её CC BY-SA. Греческий "
        ...
        collections: [
            ...
            {
                source: "bible_verses",
                file: "bible-verses-ro-1914",
                edition: "ro-1914",
                title: "Румынская синодальная 1914 (латиница) — текст стихов",
                license: CC_BY_SA,
                attribution:
                ...
                note:
                    ...
                    + "кириллическому изданию 1688 года, набранному в проекте.",
            },
            {
                source: "bible_verses",
...
export const EXCLUDED: Record<string, string> = {
    ...
    // templeAdmins) в этой базе больше не лежит — переехало в typikon-users
    // (см. src/lib/parish/db.ts), и выгрузка до него не достаёт. Записи
    // оставлены на случай, если где-то ещё жива непереехавшая копия базы:
    // сборка не должна на ней спотыкаться, а выложить эти данные — тем более.
    parishEdits: "правки приходского расписания — чужие данные приходов, живут в typikon-users",
    parishSchedules: "то же",
    parishSettings: "то же",
    templeAdmins: "кто ведёт расписание храма — персональные данные, живут в typikon-users",
    templeClaims: "заявки на ведение — персональные данные, живут в typikon-users",
