...
export const LAYERS: DumpLayer[] = [
    ...
    },
    {
        ...
        rationale:
            ...
            + "Церковнославянский, латинский и греческий Новый Завет остаются вне выгрузки: "
            + "их оцифровки чужие и разрешения на распространение не дают. Где взять их "
            + "самому — сказано ниже.",
        collections: [
            {
        ...
        pointers: [
            {
                what: "Греческий Новый Завет — Патриаршее издание 1904/1912",
                why:
                    "Наша копия взята у библиотеки Элладской Церкви (myriobiblos.gr), условий "
                    + "распространения там не заявлено.",
                where:
                    "В общественном достоянии есть текст того же издания, выверенный "
                    + "М. Робинсоном: github.com/byztxt/greektext-antoniades. Он БЕЗ УДАРЕНИЙ "
                    + "и придыханий — годен для разбора, не для чтения; поэтому на сайте "
                    + "стоит не он.",
            },
            {
