...
const EDITIONS = [
    ...
    { code: "ka-mcxeta", lang: "ka", title: "ბიბლია ძველი ქართულით (грузинская: Мцхетская рукопись и Святогорцы)" },
    { code: "en-brenton-kjv", lang: "en", title: "Английская: Брентон (ВЗ) и King James Version (НЗ)" },
    // Чувашское идёт одно: второе — тот же текст церковной азбукой, стих в стих,
    // и сверять его против славянского значило бы считать одно и то же дважды.
    { code: "cv-ipb", lang: "cv", title: "Чувашская Библия (ИПБ, еврейский счёт)" },
];
